...
public class CheckGBill extends JFrame implements ActionListener{
	private User u;
	JPanel p = new JPanel();
...
//	private static JButton button = new JButton("Search");
	...
	public CheckGBill(User u) throws IOException{
		this.u = u;
		this.setSize(1000,800);
		this.setTitle("Check Gas Bill");
...
//		button.addActionListener(this);
	...
	private void initFrame() throws IOException{
	    ...
	    ArrayList<Record> bill = file.read_from_bill("g");
	    ...
	    textPane.setText("Gas Bills of User "+u.get_username()+":");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == CheckGBill.btnGoBack){    //go back
